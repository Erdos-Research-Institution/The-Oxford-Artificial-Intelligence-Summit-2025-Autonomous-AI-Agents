...
st.markdown("---")
st.markdown("Created for the Oxford AI Summit OOP Tutorial. Explore the code and try different names/ages!")# Please move your app.py content here from streamlit_app/app.py if needed.
